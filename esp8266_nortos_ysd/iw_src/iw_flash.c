...
//还是写成函数吧，有升级那儿要用，尽量减少代码量,参数，有如果写１０次都不成功，估计是flash坏了，在升级时最好不要强制退出，不然退出也挂了
...
/*
*	 save 变量表示，是否立即保存到flash中.如果不立即保存则需要调用者在外面条用fb_block_save来保存
*/
